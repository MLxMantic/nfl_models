...
df = pd.read_csv('/home/tom/nfl_models/modeling_data/nfl_spreads_w16.csv')
...
features = pd.read_csv('/home/tom/nfl_models/modeling_data/weekly_features/feats_week10.csv')
features.drop_duplicates(inplace=True)
print(features.shape)
features = features.head(n=600)
good = list(set(features['feature']))
cols = [i for i in good if not ('left' in i or 'center' in i or 'right' in i)]+ids

df = df[cols]
df.to_csv('/home/tom/nfl_models/modeling_data/weekly_features/w15_final_feats_cut.csv', index=False)
...
dfi.export(df_styled,"/home/tom/nfl_models/predictions_final_"+str(cur_week)+".png")
